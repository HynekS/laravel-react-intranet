...
import { Info, InvoiceView, ApprovalSheet, Files, GeoFeatures } from "./lazyImports"

import type { akce as Akce } from "@codegen"

type ProjectNavProps = { detail: Akce & { user: { id: number; full_name: string } } }

const ProjectNav = ({ detail }: ProjectNavProps) => {
  return (
    <nav
      css={css`
        ${tw`pt-4`}
