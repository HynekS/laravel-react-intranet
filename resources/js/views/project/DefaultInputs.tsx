...
import type { StyleScopeObject, InputProps } from "@components/Input"
...
export const styles = {
  ...
  input: tw`border border-gray-200 text-gray-600 rounded-sm py-0.75 px-2 w-full md:w-[20ch] focus:(border-transparent outline-none ring-2 transition-shadow duration-300) placeholder:(text-gray-300)`,
