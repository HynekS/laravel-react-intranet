...
const Submit = tw.input`bg-blue-600 hover:bg-blue-700 text-white w-full font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline focus:transition-shadow focus:duration-300`
  ...
  return (
    <FormContainer>
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Submit type="submit" value="Přihlásit" />
      </Form>
    </FormContainer>
  )
}
